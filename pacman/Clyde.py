...
class Clyde:
    def __init__(self, pac):
        self.pacman = pac
        self.pos = vec(resources.tile_to_pixel(1, 29))
        self.vel = vec(1, 0)
        ...
        self.dead_count = 0
        self.active = resources.clydeActive
        self.replay = False
    ...
    def set_path_nodes(self):
        ...
        if self.return_home:
            ...
            if self.chase:
                ...
                if pacman_pos_tile.distance_to(pos_tile) > 8:
                    self.ghost_path_nodes.append(PathNode.PathNode(pacman_pos_tile.x, pacman_pos_tile.y))
                else:
                    self.ghost_path_nodes.append(PathNode.PathNode(1, 29))
            else:
                self.ghost_path_nodes.append(PathNode.PathNode(1, 29))
