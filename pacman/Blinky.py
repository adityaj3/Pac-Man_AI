...
class Blinky:
    def __init__(self, pac):
        self.pacman = pac
        self.pos = vec(resources.tile_to_pixel(13, 11))
        self.vel = vec(1, 0)
        ...
        self.dead_count = 0
        self.active = resources.blinkyActive
        self.replay = False
    ...
    def show(self):
        if self.active:
            if not self.dead_for_a_bit:
                sprite = resources.blinkySprite2
    ...
    def set_path_nodes(self):
        ...
        if self.return_home:
            ...
            if self.chase:
                ...
                self.ghost_path_nodes.append(PathNode.PathNode(1, 1))
